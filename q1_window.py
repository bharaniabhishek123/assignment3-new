...
def make_windowed_data(data, start, end, window_size = 1):
    ...
    for sentence, labels in data:
        ...
        #     windowed_data.append((flat_list[x:x + D], labels.pop(0)))
        #
        # # print windowed_data
		### END YOUR CODE
...
class WindowModel(NERModel):
    ...
    def add_embedding(self):
        ...
        # print temp.shape
        embeddings= tf.reshape(temp,(-1,cn.n_window_features*cn.embed_size))
    ...
    def add_prediction_op(self):
        ...
        # W1 = tf.get_variable("W1",shape=(cn.n_word_features*cn.embed_size,cn.hidden_size),initializer=tf.contrib.layers.xavier_intializer())

        W = tf.get_variable("Weights_Layer1", shape=(cn.n_window_features*cn.embed_size,cn.hidden_size) ,initializer=tf.contrib.layers.xavier_initializer())
    ...
    def add_loss_op(self, pred):
        ...
        out1 = tf.nn.sparse_softmax_cross_entropy_with_logits(labels=self.labels_placeholder, logits=pred)
